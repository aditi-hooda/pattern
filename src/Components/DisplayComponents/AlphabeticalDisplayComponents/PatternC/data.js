...
This code will print an 'C' made of asterisks (*) using nested loops. 
...
For The ones colored in <span class="highlighter">red</span> will be printed when <span class="highlighter">row index is 0 or 6</span>, 
So we will add it inside an if condition using OR(||) operator like below
if(i === 0 || i === 6)
For the ones colored in <span class="highlighter">blue</span> will be printed when the <span class="highlighter">column index in 0</span>,
